...
const PropertyListing = ({ properties }) => {
        ...
        {properties.map((property, index) => (
          <div className="property-item" key={index}>
            ...
            <div className='flex mb-3'>
                <IconBxBed/>            
                <div class="  mr-2 font-normal text-gray-700 dark:text-gray-400 ">{property.number_of_beds} beds</div>
                <IconBxsBath/>
                <div class=" mr-2 ml-2 font-normal text-gray-700 dark:text-gray-400">{property.number_of_bathrooms} bathrooms </div>
                <IconShapeRhombus/>
                <div class="ml-2 mr-2 font-normal text-gray-700 dark:text-gray-400">{property.area} sq ft</div>
            </div>
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
            ...
            < p    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{property.address}</ p>
        </div>
    </div>
</div> */}
